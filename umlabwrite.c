...
extern void emit_cond_move_test(Seq_T asm);
extern void emit_mapping_test(Seq_T asm);
extern void emit_io_test(Seq_T stream);
extern void emit_arith_test(Seq_T stream);
...
static struct test_info {
        ...
        {"condmove", NULL, "Conditional Move on zero register passed.\n",
         emit_cond_move_test},
        {"map", NULL, "Initial address: 1\nValue of what we stored: 2\n"
         "Second address: 1\n", emit_mapping_test},
        {"io", "Hello, world.\n", "Hello, world.\n", emit_io_test},
        {"arith", NULL, "3\n@\nA\n", emit_arith_test},
        {"nand", NULL, "?\n", emit_nand_test}
